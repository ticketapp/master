...
DECLARE placeIdToReturn int;;
  BEGIN
    INSERT INTO places (name, geographicPoint, addressId, facebookId, description, webSites, facebookMiniature,
                        capacity, openingHours)
    VALUES (nameValue, POINT(geographicPointValue), addressIdValue::BIGINT, facebookIdValue, descriptionValue,
            webSitesValue, facebookMiniatureValue, capacityValue, openingHoursValue)
