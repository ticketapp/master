app.controller('searchCtrl', ['$scope', '$rootScope', '$filter', '$timeout', 'ArtistsFactory',
    'EventsFactory', 'OrganizerFactory', 'PlaceFactory',
    function($rootScope, $scope, $filter, $timeout, ArtistsFactory, EventsFactory, OrganizerFactory, PlaceFactory){
        $scope.limit = 12;
        $scope.artists = [];
        $scope.artistsFb = [];
        $scope.organizers = [];
