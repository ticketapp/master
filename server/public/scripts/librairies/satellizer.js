...
(function(window, angular, undefined) {
    ...
    angular.module('satellizer', [])
        .constant('satellizer.config', {
            ...
            loginUrl: '/authenticate/facebook',
            signupUrl: '/authenticate/facebook',
            loginRoute: '/authenticate/facebook',
            signupRoute: '/authenticate/facebook',
            tokenRoot: false,
            tokenName: 'token',
            ...
            providers: {
                ...
                facebook: {
                    ...
                    authorizationEndpoint: '/events/1',
                    redirectUri: '/',
                    scope: ['email'],
                    scopeDelimiter: ',',
